...
import 'p_images_view_all_verified_model.dart';
export 'p_images_view_all_verified_model.dart';

class PImagesViewAllVerifiedWidget extends StatefulWidget {
  ...
  @override
  State<PImagesViewAllVerifiedWidget> createState() =>
      _PImagesViewAllVerifiedWidgetState();
}

class _PImagesViewAllVerifiedWidgetState
    extends State<PImagesViewAllVerifiedWidget> {
  late PImagesViewAllVerifiedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PImagesViewAllVerifiedModel());
