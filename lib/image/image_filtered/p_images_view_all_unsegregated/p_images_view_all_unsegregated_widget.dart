...
import 'p_images_view_all_unsegregated_model.dart';
export 'p_images_view_all_unsegregated_model.dart';

class PImagesViewAllUnsegregatedWidget extends StatefulWidget {
  ...
  @override
  State<PImagesViewAllUnsegregatedWidget> createState() =>
      _PImagesViewAllUnsegregatedWidgetState();
}

class _PImagesViewAllUnsegregatedWidgetState
    extends State<PImagesViewAllUnsegregatedWidget> {
  late PImagesViewAllUnsegregatedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PImagesViewAllUnsegregatedModel());
