...
import 'p_images_view_all_ai_model.dart';
export 'p_images_view_all_ai_model.dart';

class PImagesViewAllAiWidget extends StatefulWidget {
  ...
  @override
  State<PImagesViewAllAiWidget> createState() => _PImagesViewAllAiWidgetState();
}

class _PImagesViewAllAiWidgetState extends State<PImagesViewAllAiWidget> {
  late PImagesViewAllAiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PImagesViewAllAiModel());
