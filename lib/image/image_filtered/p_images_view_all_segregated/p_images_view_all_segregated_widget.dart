...
import 'p_images_view_all_segregated_model.dart';
export 'p_images_view_all_segregated_model.dart';

class PImagesViewAllSegregatedWidget extends StatefulWidget {
  ...
  @override
  State<PImagesViewAllSegregatedWidget> createState() =>
      _PImagesViewAllSegregatedWidgetState();
}

class _PImagesViewAllSegregatedWidgetState
    extends State<PImagesViewAllSegregatedWidget> {
  late PImagesViewAllSegregatedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PImagesViewAllSegregatedModel());
