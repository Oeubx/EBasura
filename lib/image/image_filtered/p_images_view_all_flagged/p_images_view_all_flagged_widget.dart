...
import 'p_images_view_all_flagged_model.dart';
export 'p_images_view_all_flagged_model.dart';

class PImagesViewAllFlaggedWidget extends StatefulWidget {
  ...
  @override
  State<PImagesViewAllFlaggedWidget> createState() =>
      _PImagesViewAllFlaggedWidgetState();
}

class _PImagesViewAllFlaggedWidgetState
    extends State<PImagesViewAllFlaggedWidget> {
  late PImagesViewAllFlaggedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PImagesViewAllFlaggedModel());
