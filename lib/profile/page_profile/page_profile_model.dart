...
import '/components/c_notification/c_notification_widget.dart';
...
class PageProfileModel extends FlutterFlowModel<PageProfileWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in Button_images widget.
  List<UserSubtableRow>? authQuery;
