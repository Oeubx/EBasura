...
import 'page_sign_in_model.dart';
export 'page_sign_in_model.dart';

class PageSignInWidget extends StatefulWidget {
  const PageSignInWidget({super.key});

  static String routeName = 'Page_signIn';
  static String routePath = '/pageSignIn';
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                          PageForgotPasswordWidget.routeName);
                                    },
                                    child: Text(
                                      'Forgot Password?',
                                      style: FlutterFlowTheme.of(context)
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.userQuery = await UserTable().queryRows(
                                ...
                                FFAppState().usersStreetName =
                                  ...
                                  (_model.userQuery?.unique((e) =>
                                                  e.userStreetNameRef!) !=
                                              null &&
                                          (_model.userQuery?.unique(
                                                  (e) => e.userStreetNameRef!))!
                                              .isNotEmpty)
                                      .toString(),
                                  'Street N',
                                );
                            ...
                            InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed(PageSignUpWidget.routeName);
                              },
                              child: RichText(
